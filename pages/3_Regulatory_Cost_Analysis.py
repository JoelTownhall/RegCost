    ...
    with col2:
        if gva_growth is not None:
            ...
            st.metric(
                ...
                delta_color="inverse",
                help=f"Change in Gross Value Added from {year_range[0]} to {year_range[1]}."
            )
        else:
    ...
    with col3:
        if productivity_growth is not None:
            ...
            st.metric(
                ...
                delta_color="inverse",
                help=f"Change in productivity (GVA per hour worked) from {year_range[0]} to {year_range[1]}."
            )
        else:
...
st.caption(
    ...
    "Methodology based on British Columbia requirements counting and Mercatus Center RegData approach. "
